...
export default function FilterPanel({
    ...
    return (
        <div className={`flex flex-col gap-5 ${isMobile ? 'p-10 pb-32 bg-[#061E2D]' : 'p-6'} h-fit bg-[#061E2D] border border-white/10 shadow-2xl rounded-2xl transition-all duration-500`}>
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-white/10">
                <div>
                    <h3 className="text-2xl font-black text-white font-display tracking-tight">Filters</h3>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="px-2 pt-4 pb-2 pl-8">
                    <Slider.Root
                    ...
                    >
                        ...
                        <Slider.Thumb className="block w-6 h-6 bg-white border-[4px] border-[#D33C29] shadow-[0_0_20px_rgba(211,60,41,0.6)] rounded-full cursor-grab focus:outline-none transition-transform hover:scale-120 border-solid" />
                        <Slider.Thumb className="block w-6 h-6 bg-white border-[4px] border-[#D33C29] shadow-[0_0_20px_rgba(211,60,41,0.6)] rounded-full cursor-grab focus:outline-none transition-transform hover:scale-120 border-solid" />
                    </Slider.Root>
                </div>
                <div className="flex items-center justify-between mt-3 gap-4 pl-8">
                    <div className="flex-1 bg-white/5 border border-white/10 rounded-xl px-5 py-3.5 shadow-xl">
                    ...
                    <div className="flex-1 bg-white/5 border border-white/10 rounded-xl px-5 py-3.5 shadow-xl text-right">
                ...
                <div className="grid grid-cols-2 gap-4 mt-2 pl-8">
                    {purposes.map(p => (
                        <motion.button
                            ...
                            className={`px-4 py-3.5 text-[11px] font-black uppercase tracking-[0.3em] rounded-xl transition-all border-2 ${filters.purpose === p
            ...
            {/* Logical parameters */}
            <div className="flex flex-col pt-4 border-t border-white/10 pl-8">
                <motion.button
